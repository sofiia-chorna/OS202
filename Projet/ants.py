...
if __name__ == "__main__":
    ...
    while True:
        ...
        pg.display.update()
        # if counter == 0:
        #     print(pherom.pheromon, food_counter)
        #     counter = counter + 1
        #
        # if food_counter != 0 and counter == 1:
        #     print("NOT NONNNNNNNNNNNNNNNNNNNNNNNNNNNN")
        #     print(pherom.pheromon, food_counter)
        #     counter = counter + 1

        # print("before advance", a_maze.maze)
        food_counter = ants.advance(a_maze, pos_food, pos_nest, pherom, food_counter)
        # food_counter = 0
        # print(food_counter, ants, "\n")

        # print("after pos_food", pos_food)
        # pherom.do_evaporation(pos_food)
        # print("after do_evaporation pos_food",  pos_food)
